...
HD_PWD='C:/Users/anike/class-ECE385/Final_Project/ddr3_renderer/ddr3_renderer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr_renderer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr_renderer_top.tcl
