...
HD_PWD='C:/Users/anike/class-ECE385/Final_Project/ddr3_renderer/ddr3_renderer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr_renderer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ddr_renderer_top.tcl -notrace
