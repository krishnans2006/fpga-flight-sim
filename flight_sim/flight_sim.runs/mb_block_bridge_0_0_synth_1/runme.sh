...
HD_PWD='C:/Users/krishnan/Documents/fpga-flight-sim/flight_sim/flight_sim.runs/mb_block_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_bridge_0_0.tcl
