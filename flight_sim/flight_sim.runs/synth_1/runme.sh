...
HD_PWD='C:/Users/krishnan/Documents/fpga-flight-sim/flight_sim/flight_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_sim_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flight_sim_top.tcl
