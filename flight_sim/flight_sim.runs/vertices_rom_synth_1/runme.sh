...
HD_PWD='C:/Users/krishnan/Documents/fpga-flight-sim/flight_sim/flight_sim.runs/vertices_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vertices_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vertices_rom.tcl
