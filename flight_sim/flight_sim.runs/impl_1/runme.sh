...
HD_PWD='C:/Users/krishnan/Documents/fpga-flight-sim/flight_sim/flight_sim.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flight_sim_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flight_sim_top.tcl -notrace
