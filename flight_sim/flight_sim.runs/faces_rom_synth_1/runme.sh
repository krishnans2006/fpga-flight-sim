...
HD_PWD='C:/Users/krishnan/Documents/fpga-flight-sim/flight_sim/flight_sim.runs/faces_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log faces_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source faces_rom.tcl
